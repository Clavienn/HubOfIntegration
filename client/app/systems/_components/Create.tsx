...
import { CreateSystem, CreateSystemSchema } from '@/domains/models/System';
import { systemRepo } from '@/infrastructures/repository/SystemRepoAPI';

interface SystemCreateProps {
  open: boolean;
  onClose: () => void;
  onCreated: () => void;
}

export default function SystemCreate({ open, onClose, onCreated }: SystemCreateProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          <DialogTitle>Nouveau Système</DialogTitle>
        </DialogHeader>
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              <div className="space-y-1">
                ...
                {errors.retryPolicy?.delayMs && (
                  <p className="text-xs text-red-500">{errors.retryPolicy.delayMs.message}</p>
                )}
              </div>
